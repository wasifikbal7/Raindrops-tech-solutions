    ...
    <div className="font-semibold transition-transform drop-shadow-lg right-20 top-3 active:scale-90">
      <a href={pdfppt} target='_blank'>
        <button
          ...
          className="py-2 px-8 text-lg font-semibold hover:underline duration-300 ease-in-out hover:text-teal-500 border-2 bg-gradient-to-b from-white from-45% to-zinc-400 rounded-3xl text-slate-800 hover:text-accent-foreground hover:scale-105 transition-all border-white shadow-md shadow-slate-600"
        >
          Download Brochure
        </button>
      </a>
